...
export function Projects() {
  return (
    <section id="projects" className="relative mx-auto max-w-6xl px-4 py-20 sm:px-6 sm:py-24">
        ...
        {PROJECTS.map((project, i) => (
          <Reveal key={project.title} delay={i * 0.06}>
            <article className="glow-card group relative flex h-full flex-col overflow-hidden rounded-2xl p-7">
              ...
              <h3 className="text-lg font-semibold leading-snug sm:text-xl">{project.title}</h3>
              ...
              <div className="mt-7 flex flex-wrap gap-3 pt-1">
                <Button asChild variant="glass" size="sm" className="rounded-lg">
